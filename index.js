...
var colorFormat = '234,34,145';

function colorFormatConverter(colorFormat) {

	function verifyFormat(input) {
		var result = input.includes(',') ?
	...
	function rgbToHex(input) {
		...
		console.log(`rgb(${input})'s equivalent HEX value is:`);
		return (newArr.join(''));
	}
	...
	function hexToRgb(input) {
		...
		console.log(`HEX #${input}'s equivalent RGB value is:`);
		return (result);
	}
...
/**
 * Auto Detects Color Format and converts it from RGB to HEX and vice versa
 * @param {string} colorFormat
 * @return {string}
 */
module.exports = colorFormatConverter(colorFormat);